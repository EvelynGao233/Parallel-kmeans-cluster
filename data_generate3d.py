...
def generate_3d_points(num_points, filename, folder):
    ...
    for center, spread in cluster_centers_and_spreads:
        cluster_points = np.random.normal(loc=center, scale=spread, size=(num_points // len(cluster_centers_and_spreads), 3))
...
def main():
    ...
    for num_points, filename in datasets:
        generate_3d_points(num_points, filename, folder)
